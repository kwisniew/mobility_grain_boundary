function Ef=findFermi(Na, T, delta, L, Qt, Et, delta_Et, Eg, epsR)
    ...
    function cnc_expression = charge_neut_cond(Ef)
        ...
        switch T
            ...
            case 112.5
                Q1 = Q_integral_fun(b1,4.55675,1.94923,0.14271 ,0.0274443,0.70034,0.101886 ,0.194487);
            case 125
                Q1 = Q_integral_fun(b1,4.10107,1.83414,0.165529,0.0318326,0.678831,0.121922,0.216096);
            case 137.5
                Q1 = Q_integral_fun(b1,3.72825,1.7252 ,0.18774 ,0.0361039,0.65722 ,0.142829,0.237706);
            case 150
                Q1 = Q_integral_fun(b1,3.41756,1.62323,0.209078,0.0402073,0.635766,0.16443 ,0.259316);
            case 162.5
                Q1 = Q_integral_fun(b1,3.15467,1.52853,0.229366,0.0441088,0.614674,0.186575,0.280925);
            case 175
                Q1 = Q_integral_fun(b1,2.92934,1.44107,0.248498,0.0477881,0.594098,0.209139,0.302535);
            case 187.5
                Q1 = Q_integral_fun(b1,2.73405,1.36059,0.266428,0.0512361,0.574146,0.232021,0.324144);
            case 200
        ...
        switch T
            ...
            case 112.5
                Q2 = Q_integral_fun(b2,4.55675,1.94923,0.14271 ,0.0274443,0.70034,0.101886 ,0.194487);
            case 125
                Q2 = Q_integral_fun(b2,4.10107,1.83414,0.165529,0.0318326,0.678831,0.121922,0.216096);
            case 137.5
                Q2 = Q_integral_fun(b2,3.72825,1.7252 ,0.18774 ,0.0361039,0.65722 ,0.142829,0.237706);
            case 150
                Q2 = Q_integral_fun(b2,3.41756,1.62323,0.209078,0.0402073,0.635766,0.16443 ,0.259316);
            case 162.5
                Q2 = Q_integral_fun(b2,3.15467,1.52853,0.229366,0.0441088,0.614674,0.186575,0.280925);
            case 175
                Q2 = Q_integral_fun(b2,2.92934,1.44107,0.248498,0.0477881,0.594098,0.209139,0.302535);
            case 187.5
                Q2 = Q_integral_fun(b2,2.73405,1.36059,0.266428,0.0512361,0.574146,0.232021,0.324144);
            case 200
